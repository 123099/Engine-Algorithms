...
void Mesh::streamToOpenGL(GLint pVerticesAttrib, GLint pNormalsAttrib, GLint pUVsAttrib, GLenum drawMode)
{
	...
	glDrawElements(drawMode, _indices.size(), GL_UNSIGNED_INT, (GLvoid*)0);
