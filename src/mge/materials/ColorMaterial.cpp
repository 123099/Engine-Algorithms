...
void ColorMaterial::render(Mesh* pMesh, const glm::mat4& pModelMatrix, const glm::mat4& pViewMatrix, const glm::mat4& pProjectionMatrix, GLenum drawMode) {
    _shader->use();
    ...
    pMesh->streamToOpenGL(_aVertex, _aNormal, _aUV, drawMode);
