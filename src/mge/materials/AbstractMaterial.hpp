...
class AbstractMaterial
{
    public:
         ...
         */
        virtual void render(Mesh* pMesh, const glm::mat4& pModelMatrix, const glm::mat4& pViewMatrix, const glm::mat4& pPerspectiveMatrix, GLenum drawMode = GL_TRIANGLES) = 0;
};
