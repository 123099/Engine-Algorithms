...
class OcTreeBase final : public OcTreeImpl
{
public:
	OcTreeBase(unsigned layer, const glm::vec3& center, const glm::vec3& halfExtents);
...
private:
	...
	std::array<std::unique_ptr<OcTreeBase>, 8> m_nodes;										//The child nodes that this tree node has split to
